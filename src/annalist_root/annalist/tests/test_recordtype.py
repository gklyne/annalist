...
class RecordTypeTest(AnnalistTestCase):
    ...
    @classmethod
    def setUpClass(cls):
        super(RecordTypeTest, cls).setUpClass()
        return

    @classmethod
    def tearDownClass(cls):
        super(RecordTypeTest, cls).tearDownClass()
...
class RecordTypeEditViewTest(AnnalistTestCase):
    ...
    @classmethod
    def setUpClass(cls):
        super(RecordTypeEditViewTest, cls).setUpClass()
        return

    @classmethod
    def tearDownClass(cls):
        super(RecordTypeEditViewTest, cls).tearDownClass()
        resetSitedata()
        return
