...
class AnnalistSiteDataTest(AnnalistTestCase):
    ...
    # Convert list of ids into list of field choices
    def makeFieldChoice(self, options):
    ...
    def test_collection_edit(self):
        ...
        local_types_expected = self.makeFieldChoice(
    ...
    def test_view_edit_type_view(self):
        ...
        s = self.get_page(u)
        expect_field_choices = get_site_type_fields_sorted()
        expect_fields = (
            [ "Type_id"
            , "Type_label"
            , "Type_comment"
    ...
    def test_view_edit_list_view(self):
        ...
        s = self.get_page(u)
        expect_field_choices = get_site_list_fields_sorted()
        expect_fields = (
            [ "List_id"
            , "List_type"
            , "List_label"
    ...
    def test_view_edit_group_view(self):
        ...
        s = self.get_page(u)
        expect_field_choices = get_site_group_fields_sorted()
        expect_fields = (
            [ "Group_id"
            , "Group_label"
            , "Group_comment"
    ...
    def test_view_edit_field_view(self):
        ...
        s = self.get_page(u)
        expect_field_choices = get_site_field_fields_sorted()
        expect_fields = (
            [ "Field_id"
            , "Field_type"
            , "Field_label"
    ...
    def test_view_edit_user_view(self):
        ...
        s = self.get_page(u)
        expect_field_choices = get_site_user_fields_sorted()
        expect_fields = (
            [ "User_id"
            , "User_name"
            , "User_description"
