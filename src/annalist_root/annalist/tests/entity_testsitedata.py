...
site_field_types = (
    ...
    , FieldChoice("_enum_render_type/Enum",             label="Reference to selected or new entity")
    , FieldChoice("_enum_render_type/Enum_choice",      label="Reference to selected entity" )
    , FieldChoice("_enum_render_type/Enum_choice_opt",  label="Optional reference to selected entity")
    , FieldChoice("_enum_render_type/Enum_optional",    label="Optional reference to selected or new entity")
