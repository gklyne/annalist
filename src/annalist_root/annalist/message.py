...
TASK_CREATE_REFERENCE_FIELD = "Created reference to field '%(field_id)s' (select 'Refer to type' value on current display, and re-save)"

# Strings for data generated by task buttons

TYPE_VIEW_LABEL             = "%s"
TYPE_VIEW_COMMENT           = "%s view"

TYPE_LIST_LABEL             = "%s list"
TYPE_LIST_COMMENT           = "%s list"

REPEAT_FIELD_LABEL          = "%s (repeating)"
REPEAT_FIELD_COMMENT        = "%s (repeating)"
REPEAT_FIELD_PLACEHOLDER    = "(Repeat field %s)"
REPEAT_FIELD_ADD            = "Add %s"
REPEAT_FIELD_DELETE         = "Remove %s"
