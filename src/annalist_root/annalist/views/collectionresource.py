...
class CollectionResourceAccess(AnnalistGenericView):
    ...
    This view class returns a data resource.
    """
    ...
    def get(self, request, 
        ...
        resource_file = coll.field_resource_file(resource_info["resource_name"])
    ...
    def find_resource(self, viewinfo, coll, resource_ref):
        ...
        if resource_ref == layout.COLL_CONTEXT_FILE:
            return (
                { 'resource_type': "application/json-ld"
