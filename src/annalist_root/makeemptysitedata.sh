...
echo "cp -r $BASEDIR/sampledata/data/annalist_test/c $BASEDIR/sampledata/empty/annalist_site/"
mkdir -p $BASEDIR/sampledata/empty/annalist_site/
cp -r $BASEDIR/sampledata/data/annalist_test/c $BASEDIR/sampledata/empty/annalist_site/

echo "cp $BASEDIR/sampledata/data/annalist_test/README.md $BASEDIR/sampledata/empty/annalist_site/"
cp $BASEDIR/sampledata/data/annalist_test/README.md $BASEDIR/sampledata/empty/annalist_site/
