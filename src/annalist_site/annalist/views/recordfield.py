"""
Annalist record field description view
...
class RecordFieldEditView(EntityEditBaseView):
    """
    View class to handle requests to an Annalist record field edit URI
    """
    ...
    _entityvaluemap     = (
        ...
        , StableValueMap(c='field_id',         e='annal:id',     f='entity_id'        )
    ...
    def __init__(self):
        super(RecordFieldEditView, self).__init__()
        return
    ...
    def get(self, request, coll_id=None, type_id=None, action=None):
        ...
        # Set up RecordField-specific values
    ...
    def post(self, request, coll_id=None, type_id=None, action=None):
        ...
        """
        log.debug("views.recordlist.post %s"%(self.get_request_path()))
...
class RecordFieldDeleteConfirmedView(EntityDeleteConfirmedBaseView):
    """
    View class to perform completion of confirmed record type deletion, requested
    from collection edit view.
    """
    def __init__(self):
        super(RecordFieldDeleteConfirmedView, self).__init__()
        return
    ...
    def post(self, request, coll_id):
        ...
        """
        log.debug("RecordFieldDeleteConfirmedView.post: %r"%(request.POST))
