...
An intended core feature that will probably not make the first release is bridges to other data sources, in particular to allow Annalist to work with existing spreadhseet data.
