...
[.right.text-center]
.Annalist login form
image::screenshot-login-form.png[Annalist login form,400,300,width=400]
...
[.right.text-center]
.Annalist logged in
image::screenshot-login-form.png[Annalist logged in,400,300,width=400]

Once the login is complete, click on "Home" in the menu bar to return to the main Annalist site

[.right.text-center]
.Annalist home page
image::screenshot-login-form.png[Annalist home page,400,300,width=400]
...
image::screenshot-annalist-permissions.png[Annalist collection user permissions,400,300,width=400]
...
image::screenshot-annalist-permissions-new.png[Annalist collection new user permissions,400,300,width=400]
