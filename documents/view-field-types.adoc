...
1. http://foundation.zurb.com[Foundation responsive web framwork]

2. http://foundation.zurb.com/docs/components/grid.html[Foundation grid]

3. http://www.w3.org/TR/curie/[CURIE]

4. https://tools.ietf.org/html/rfc3986[URI]
